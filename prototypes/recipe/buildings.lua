...
local building_recipes = {
  ...
  not_in_space(entity_recipe("passenger-wagon",          { type = "recipe", subgroup = "train-transport", order = "z[passenger-wagon]", enabled = false, ingredients = {{type="item", name="cargo-wagon", amount=1}, {type="item", name="electronic-circuit", amount=10}, {type="item", name="steel-plate", amount=10}}, results = {{type="item", name="passenger-wagon", amount=1}}, energy_required = 10 })),
  not_in_space(entity_recipe("boarding-platform",        { type = "recipe", subgroup = "admin-transit", order = "b", enabled = false, ingredients = {{type="item", name="iron-plate", amount=10}, {type="item", name="electronic-circuit", amount=5}, {type="item", name="constant-combinator", amount=1}}, results = {{type="item", name="boarding-platform", amount=1}}, energy_required = 5 })),
  not_in_space(entity_recipe("deboarding-platform",      { type = "recipe", subgroup = "admin-transit", order = "c", enabled = false, ingredients = {{type="item", name="iron-plate", amount=10}, {type="item", name="electronic-circuit", amount=5}, {type="item", name="constant-combinator", amount=1}}, results = {{type="item", name="deboarding-platform", amount=1}}, energy_required = 5 })),
  ...
  not_in_space(entity_recipe("tube-pump",                  { type = "recipe", subgroup = "admin-infrastructure", order = "g-h", enabled = false, allow_quality = false, ingredients = {{type="item", name="iron-plate", amount=10}, {type="item", name="pneumatic-pipe", amount=4}, {type="item", name="electronic-circuit", amount=5}, {type="item", name="compacted-rubble", amount=5}}, results = {{type="item", name="tube-pump", amount=1}},                  energy_required = 5 })),
}
