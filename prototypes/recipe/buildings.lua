...
data:extend({
  ...
  entity_recipe("paperwork-provider-chest",  { type = "recipe", enabled = false, ingredients = {{type="item", name="wooden-chest", amount=1}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="work-order", amount=1}}, results = {{type="item", name="paperwork-provider-chest", amount=1}}, energy_required = 1 }),
  entity_recipe("paperwork-storage-chest",   { type = "recipe", enabled = false, ingredients = {{type="item", name="wooden-chest", amount=1}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="provisional-approval", amount=1}}, results = {{type="item", name="paperwork-storage-chest", amount=1}}, energy_required = 1 }),
  entity_recipe("paperwork-requester-chest", { type = "recipe", enabled = false, ingredients = {{type="item", name="wooden-chest", amount=1}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="management-verbal-draft", amount=1}}, results = {{type="item", name="paperwork-requester-chest", amount=1}}, energy_required = 1 }),
  ...
  -- Printers
  entity_recipe("mechanical-printer",        { type = "recipe", enabled = true,  ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="stone", amount=5}, {type="item", name="paper", amount=5}},                                                                        results = {{type="item", name="mechanical-printer", amount=1}}, energy_required = 5 }),
