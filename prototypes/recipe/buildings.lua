...
data:extend({
  ...
  entity_recipe("greenhouse",                { type = "recipe", enabled = false, ingredients = {{type="item", name="iron-plate", amount=10}},                                                                                                                                                     results = {{type="item", name="greenhouse", amount=1}},       energy_required = 10 }),
  entity_recipe("union-headquarters",        { type = "recipe", enabled = false, ingredients = {{type="item", name="steel-plate", amount=50}, {type="item", name="advanced-circuit", amount=20}, {type="item", name="construction-permit", amount=5}, {type="item", name="treasury-bond", amount=5}}, results = {{type="item", name="union-headquarters", amount=1}}, energy_required = 30 }),
  ...
  -- Printers
  entity_recipe("mechanical-printer",        { type = "recipe", enabled = true,  ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="stone", amount=5}, {type="item", name="paper", amount=10}},                                                                       results = {{type="item", name="mechanical-printer", amount=1}}, energy_required = 5 }),
  ...
  entity_recipe("pneumatic-pipe",            { type = "recipe", enabled = false, ingredients = {{type="item", name="iron-plate", amount=2}, {type="item", name="compacted-rubble", amount=1}},                                                     results = {{type="item", name="pneumatic-pipe", amount=2}},            energy_required = 1 }),
  entity_recipe("pneumatic-pipe-to-ground",  { type = "recipe", enabled = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="pneumatic-pipe", amount=10}},                                                      results = {{type="item", name="pneumatic-pipe-to-ground", amount=2}},  energy_required = 3 }),
  entity_recipe("form-liquifier",            { type = "recipe", enabled = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="compacted-rubble", amount=3}},  results = {{type="item", name="form-liquifier", amount=1}},            energy_required = 3 }),
  entity_recipe("form-solidifier",           { type = "recipe", enabled = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="compacted-rubble", amount=3}},  results = {{type="item", name="form-solidifier", amount=1}},           energy_required = 3 }),
})
