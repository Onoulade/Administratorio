...
local building_recipes = {
  ...
  not_in_space(entity_recipe("field-office",               { type = "recipe", subgroup = "admin-biter-buildings", enabled = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="stone-brick", amount=2}, {type="item", name="dubious-data", amount=1}}, results = {{type="item", name="field-office", amount=1}}, energy_required = 5 })),
  not_in_space(entity_recipe("office-desk",               { type = "recipe", subgroup = "admin-buildings", enabled = false, ingredients = {{type="item", name="iron-plate", amount=20}, {type="item", name="iron-gear-wheel", amount=10}, {type="item", name="electronic-circuit", amount=10}, {type="item", name="biter-worker", amount=1}},                                            results = {{type="item", name="office-desk", amount=2}},      energy_required = 10 })),
  not_in_space(entity_recipe("biter-station",             { type = "recipe", subgroup = "admin-biter-buildings", enabled = false, ingredients = {{type="item", name="iron-plate", amount=10}, {type="item", name="electronic-circuit", amount=5}, {type="item", name="provisional-approval", amount=2}, {type="item", name="taxpayer-money", amount=20}}, results = {{type="item", name="biter-station", amount=1}}, energy_required = 10 })),
  not_in_space(entity_recipe("biterport",                 { type = "recipe", subgroup = "admin-biter-buildings", category = "bureaucracy-registration", enabled = false, ingredients = {{type="item", name="iron-plate", amount=20}, {type="item", name="electronic-circuit", amount=10}, {type="item", name="construction-permit", amount=1}, {type="item", name="taxpayer-money", amount=30}}, results = {{type="item", name="biterport", amount=1}}, energy_required = 15 })),
  entity_recipe("paperwork-provider-chest",  { type = "recipe", subgroup = "admin-infrastructure", enabled = false, ingredients = {{type="item", name="wooden-chest", amount=1}, {type="item", name="paper", amount=2}, {type="item", name="work-order", amount=1}}, results = {{type="item", name="paperwork-provider-chest", amount=1}}, energy_required = 1 }),
  entity_recipe("paperwork-storage-chest",   { type = "recipe", subgroup = "admin-infrastructure", enabled = false, ingredients = {{type="item", name="wooden-chest", amount=1}, {type="item", name="paper", amount=2}, {type="item", name="provisional-approval", amount=1}}, results = {{type="item", name="paperwork-storage-chest", amount=1}}, energy_required = 1 }),
  entity_recipe("paperwork-requester-chest", { type = "recipe", subgroup = "admin-infrastructure", enabled = false, ingredients = {{type="item", name="wooden-chest", amount=1}, {type="item", name="paper", amount=2}, {type="item", name="management-verbal-draft", amount=1}}, results = {{type="item", name="paperwork-requester-chest", amount=1}}, energy_required = 1 }),
  nauvis_only(entity_recipe("admin-station",             { type = "recipe", subgroup = "admin-biter-buildings", enabled = false, ingredients = {{type="item", name="iron-plate", amount=20}, {type="item", name="electronic-circuit", amount=10}, {type="item", name="provisional-approval", amount=1}},                                            results = {{type="item", name="admin-station", amount=1}},    energy_required = 15 })),
  formation_center_recipe,
  not_in_space(entity_recipe("resolution-office",         { type = "recipe", subgroup = "admin-biter-buildings", enabled = false, ingredients = {{type="item", name="iron-plate", amount=30}, {type="item", name="electronic-circuit", amount=20}, {type="item", name="provisional-approval", amount=1}, {type="item", name="biter-worker", amount=1}},                                            results = {{type="item", name="resolution-office", amount=2}},energy_required = 20 })),
  not_in_space(not_on_vulcanus(entity_recipe("greenhouse",{ type = "recipe", subgroup = "admin-production", enabled = false, ingredients = {{type="item", name="iron-plate", amount=10}, {type="item", name="stone-brick", amount=10}, {type="item", name="pipe", amount=2}},                                                 results = {{type="item", name="greenhouse", amount=1}},       energy_required = 10 }))),
  not_in_space(entity_recipe("union-headquarters",        { type = "recipe", subgroup = "admin-buildings", enabled = false, ingredients = {{type="item", name="steel-plate", amount=45}, {type="item", name="advanced-circuit", amount=18}, {type="item", name="construction-permit", amount=3}, {type="item", name="treasury-bond", amount=3}, {type="item", name="management-approval-verbal", amount=1}, {type="item", name="management-verbal-work-order", amount=1}}, results = {{type="item", name="union-headquarters", amount=1}}, energy_required = 35 })),
  not_in_space(entity_recipe("propaganda-distillery",     { type = "recipe", subgroup = "admin-buildings", enabled = false, ingredients = {{type="item", name="steel-plate", amount=20}, {type="item", name="pipe", amount=10}, {type="item", name="electronic-circuit", amount=10}, {type="item", name="compacted-rubble", amount=5}, {type="item", name="construction-work-order", amount=1}}, results = {{type="item", name="propaganda-distillery", amount=1}}, energy_required = 15 })),

  -- Printers
  not_in_space(entity_recipe("mechanical-printer",        { type = "recipe", subgroup = "admin-printers", enabled = true,  ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="stone", amount=5}, {type="item", name="paper", amount=5}},                                                                        results = {{type="item", name="mechanical-printer", amount=1}}, energy_required = 5 })),
  not_in_space(entity_recipe("printer-t1",                { type = "recipe", subgroup = "admin-printers", enabled = false, ingredients = {{type="item", name="iron-plate", amount=10}, {type="item", name="iron-gear-wheel", amount=5}, {type="item", name="electronic-circuit", amount=3}, {type="item", name="provisional-approval", amount=1}}, results = {{type="item", name="printer-t1", amount=1}},    energy_required = 5 })),
  entity_recipe("printer-t2",                { type = "recipe", subgroup = "admin-printers", enabled = false, ingredients = {{type="item", name="steel-plate", amount=12}, {type="item", name="advanced-circuit", amount=8}, {type="item", name="iron-gear-wheel", amount=8}, {type="item", name="printer-t1", amount=1}, {type="item", name="construction-permit", amount=1}, {type="item", name="safety-work-order", amount=1}},   results = {{type="item", name="printer-t2", amount=1}},       energy_required = 10 }),

  -- Pneumatic Form Transport
  not_in_space(entity_recipe("pneumatic-pipe",            { type = "recipe", subgroup = "admin-infrastructure", enabled = false, allow_quality = false, ingredients = {{type="item", name="iron-plate", amount=2}, {type="item", name="pipe", amount=1}, {type="item", name="compacted-rubble", amount=1}},                               results = {{type="item", name="pneumatic-pipe", amount=2}},            energy_required = 1 })),
  not_in_space(entity_recipe("pneumatic-pipe-to-ground",  { type = "recipe", subgroup = "admin-infrastructure", enabled = false, allow_quality = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="pneumatic-pipe", amount=10}, {type="item", name="construction-permit", amount=1}},   results = {{type="item", name="pneumatic-pipe-to-ground", amount=2}},  energy_required = 3 })),
  not_in_space(entity_recipe("tube-intake",                { type = "recipe", subgroup = "admin-infrastructure", enabled = false, allow_quality = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="pipe", amount=2}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="compacted-rubble", amount=3}}, results = {{type="item", name="tube-intake", amount=1}},              energy_required = 3 })),
  not_in_space(entity_recipe("tube-outtake",               { type = "recipe", subgroup = "admin-infrastructure", enabled = false, allow_quality = false, ingredients = {{type="item", name="iron-plate", amount=5}, {type="item", name="pipe", amount=2}, {type="item", name="electronic-circuit", amount=2}, {type="item", name="compacted-rubble", amount=3}}, results = {{type="item", name="tube-outtake", amount=1}},             energy_required = 3 })),
}
