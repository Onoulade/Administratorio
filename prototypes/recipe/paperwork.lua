data:extend({
  ...
  -- Form 27b-6
  { type = "recipe", name = "form-27b-6", category = "printing", enabled = false, ingredients = {{type="item", name="blank-form", amount=1}, {type="item", name="ink", amount=1}, {type="item", name="useless-documentation", amount=1}}, results = {{type="item", name="form-27b-6", amount=1}}, energy_required = 3 },
  ...
  { type = "recipe", name = "environmental-impact-report", category = "printing", enabled = false, ingredients = {{type="item", name="crappy-report", amount=1}, {type="item", name="form-27b-6", amount=1}, {type="item", name="barrel", amount=1}, {type="item", name="ink", amount=2}}, results = {{type="item", name="environmental-impact-report", amount=1}}, energy_required = 10 },
  ...
  { type = "recipe", name = "management-written-proposal",    category = "bureaucracy-policy", enabled = false, ingredients = {{type="item", name="blank-directive", amount=1}, {type="item", name="good-excuse", amount=1}, {type="item", name="narrative", amount=1}, {type="item", name="treasury-bond", amount=1}, {type="item", name="advanced-circuit", amount=2}, {type="fluid", name="liquid-coffee", amount=50}}, results = {{type="item", name="management-written-proposal", amount=1}}, energy_required = 10 },
  { type = "recipe", name = "management-written-1st-printing", category = "printing",         enabled = false, ingredients = {{type="item", name="management-written-proposal", amount=1}, {type="item", name="ink", amount=2}, {type="item", name="form-27b-6", amount=1}}, results = {{type="item", name="management-written-review", amount=1}}, energy_required = 5 },
  ...
  -- Direct draft-to-work-order printing (Printer T1/T2 only)
  { type = "recipe", name = "safety-work-order-printing",        category = "printing-workorder", enabled = false, ingredients = {{type="item", name="safety-waiver-draft", amount=1},       {type="item", name="work-order", amount=1}}, results = {{type="item", name="safety-work-order", amount=2}},        energy_required = 4 },
  { type = "recipe", name = "construction-work-order-printing",  category = "printing-workorder", enabled = false, ingredients = {{type="item", name="construction-permit-draft", amount=1}, {type="item", name="work-order", amount=1}}, results = {{type="item", name="construction-work-order", amount=2}},  energy_required = 6 },
  { type = "recipe", name = "research-grant-work-order-printing",category = "printing-workorder", enabled = false, ingredients = {{type="item", name="research-grant-approval", amount=1},  {type="item", name="work-order", amount=1}}, results = {{type="item", name="research-grant-work-order", amount=2}}, energy_required = 4 },
