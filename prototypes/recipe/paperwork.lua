data:extend({
  ...
  { type = "recipe", name = "environmental-impact-report", category = "printing", enabled = false, ingredients = {{type="item", name="crappy-report", amount=1}, {type="item", name="form-27b-6", amount=1}, {type="item", name="ink", amount=2}}, results = {{type="item", name="environmental-impact-report", amount=1}}, energy_required = 10 },
