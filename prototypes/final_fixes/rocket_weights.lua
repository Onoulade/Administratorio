...
function M.apply()
  ...
  set_weights("item", {"trajectory-compliance-array", "senior-trajectory-compliance-array", "executive-trajectory-compliance-array", "orbital-employment-catapult", "administrative-space-station"}, 1 * tons)
