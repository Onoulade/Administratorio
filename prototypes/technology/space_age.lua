...
-- actually mined it.  This covers both local Vulcanus processes and orbital
-- recipes that import the material from Vulcanus.
add_tech_prerequisite("vulcanus-export-charters", "calcite-processing")
add_tech_prerequisite("advanced-asteroid-processing", "calcite-processing")
...
add_tech_unlock("calcite-processing", "redundant-rubble-recovery-vulcanus")
add_tech_unlock("calcite-processing", "refined-nonsense-production-vulcanus")
