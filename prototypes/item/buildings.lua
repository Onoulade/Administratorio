...
data:extend({
  ...
  { type = "item", name = "resolution-office",         icon = entity_graphics .. "scrubber/base/scrubber-icon.png",                  icon_size = 64,  subgroup = "admin-buildings", order = "b2", place_result = "resolution-office",         stack_size = 50 },
