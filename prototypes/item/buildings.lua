...
data:extend({
  ...
  { type = "item", name = "tube-pump",                  icons = {{icon = "__base__/graphics/icons/pump.png", icon_size = 64, tint = {r=0.85, g=0.75, b=0.55, a=1}}}, subgroup = "admin-infrastructure", order = "e3", place_result = "tube-pump",                  stack_size = 20 },
  -- Biter-operated logistics chests -> Biters tab, admin-biter-logistics (with biterport)
  { type = "item", name = "paperwork-provider-chest",   icons = {{icon = "__base__/graphics/icons/wooden-chest.png", icon_size = 64, tint = {r=1.0, g=0.48, b=0.42, a=1}}, {icon = item_icons .. "paper.png", icon_size = 64, scale = 0.34, shift = {8, 8}}}, subgroup = "admin-biter-logistics", order = "e", place_result = "paperwork-provider-chest", stack_size = 50 },
  { type = "item", name = "paperwork-storage-chest",    icons = {{icon = "__base__/graphics/icons/wooden-chest.png", icon_size = 64, tint = {r=1.0, g=0.86, b=0.38, a=1}}, {icon = item_icons .. "paper.png", icon_size = 64, scale = 0.34, shift = {8, 8}}}, subgroup = "admin-biter-logistics", order = "f", place_result = "paperwork-storage-chest", stack_size = 50 },
  { type = "item", name = "paperwork-requester-chest",  icons = {{icon = "__base__/graphics/icons/wooden-chest.png", icon_size = 64, tint = {r=0.38, g=0.66, b=1.0, a=1}}, {icon = item_icons .. "paper.png", icon_size = 64, scale = 0.34, shift = {8, 8}}}, subgroup = "admin-biter-logistics", order = "g", place_result = "paperwork-requester-chest", stack_size = 50 },
...
data:extend({
  ...
  { type = "item", name = "biterport",                 icon = item_icons .. "biterport.png", icon_size = 64, subgroup = "admin-biter-logistics", order = "a", place_result = "biterport-placement-preview", stack_size = 20 },
  { type = "item", name = "admin-station",             icon = item_icons .. "admin-desk.png",                                  icon_size = 64,  subgroup = "admin-biter-logistics", order = "c",  place_result = "admin-station",             stack_size = 50 },
