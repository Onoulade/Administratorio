...
data:extend({
  ...
  { type = "item", name = "optical-fibre",              icons = {{icon = "__base__/graphics/icons/pipe.png", icon_size = 64, tint = {r = 0.35, g = 0.8, b = 1.0, a = 1}}}, subgroup = "admin-infrastructure", order = "e3", place_result = "optical-fibre",           stack_size = 100 },
  { type = "item", name = "optical-fibre-to-ground",     icons = {{icon = "__base__/graphics/icons/pipe-to-ground.png", icon_size = 64, tint = {r = 0.35, g = 0.8, b = 1.0, a = 1}}}, subgroup = "admin-infrastructure", order = "e4", place_result = "optical-fibre-to-ground",  stack_size = 50 },
