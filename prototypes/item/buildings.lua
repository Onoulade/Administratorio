...
data:extend({
  ...
  { type = "item", name = "biterport",                 icons = {{icon = item_icons .. "admin-desk.png", icon_size = 64, tint = {r=0.55, g=0.85, b=0.5, a=1}}}, subgroup = "admin-biter-buildings", order = "a1", place_result = "biterport", stack_size = 20 },
