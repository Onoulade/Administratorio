...
data:extend({
  ...
  { type = "item", name = "resolved-landscape",   icon = item_icons .. "resolved-landscape.png",   icon_size = 64, subgroup = "resolution-landscape", order = "c", stack_size = 50 },
  ...
  { type = "item", name = "resolved-smog",        icon = item_icons .. "resolved-smog.png",        icon_size = 64, subgroup = "resolution-smog", order = "d", stack_size = 50 },
  ...
  { type = "item", name = "brief-n",              icon = item_icons .. "brief-n.png",              icon_size = 64, subgroup = "resolution-noise", order = "d", stack_size = 10 },
  { type = "item", name = "resolved-noise",       icon = item_icons .. "resolved-noise.png",       icon_size = 64, subgroup = "resolution-noise", order = "e", stack_size = 50 },
  ...
  { type = "item", name = "brief-u",              icon = item_icons .. "brief-u.png",              icon_size = 64, subgroup = "resolution-unemployment", order = "d", stack_size = 10 },
  { type = "item", name = "resolved-unemployment", icon = item_icons .. "resolved-unemployment.png", icon_size = 64, subgroup = "resolution-unemployment", order = "e", stack_size = 50 },
  ...
  { type = "item", name = "resolved-littering",   icon = item_icons .. "resolved-littering.png",   icon_size = 64, subgroup = "resolution-littering", order = "c", stack_size = 50 },
  ...
  { type = "item", name = "resolved-hazmat",      icon = item_icons .. "resolved-hazmat.png",      icon_size = 64, subgroup = "resolution-hazmat", order = "d", stack_size = 50 },
  ...
  { type = "item", name = "brief-lo",             icon = item_icons .. "brief-lo.png",             icon_size = 64, subgroup = "resolution-loitering", order = "d", stack_size = 10 },
  { type = "item", name = "resolved-loitering",   icon = item_icons .. "resolved-loitering.png",   icon_size = 64, subgroup = "resolution-loitering", order = "e", stack_size = 50 },
  ...
  { type = "item", name = "brief-v",              icon = item_icons .. "brief-v.png",              icon_size = 64, subgroup = "resolution-vagrancy", order = "d", stack_size = 10 },
  { type = "item", name = "resolved-vagrancy",    icon = item_icons .. "resolved-vagrancy.png",    icon_size = 64, subgroup = "resolution-vagrancy", order = "e", stack_size = 50 },
})
