...
data:extend({
  ...
  { type = "item", name = "brief-n",              icons = {{icon = item_icons .. "case-n.png", icon_size = 64, tint = {r=1.0, g=0.78, b=0.35, a=1}}}, subgroup = "resolution-noise", order = "d", stack_size = 10, hidden = true, hidden_in_factoriopedia = true },
  ...
  { type = "item", name = "brief-u",              icons = {{icon = item_icons .. "case-u.png", icon_size = 64, tint = {r=1.0, g=0.78, b=0.35, a=1}}}, subgroup = "resolution-unemployment", order = "d", stack_size = 10, hidden = true, hidden_in_factoriopedia = true },
  ...
  { type = "item", name = "brief-lo",             icons = {{icon = item_icons .. "case-lo.png", icon_size = 64, tint = {r=1.0, g=0.78, b=0.35, a=1}}}, subgroup = "resolution-loitering", order = "d", stack_size = 10, hidden = true, hidden_in_factoriopedia = true },
