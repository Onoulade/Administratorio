...
local function init_storage()
  ...
  automation_grievances.ensure_storage()
  if WORKING_HOURS_ENABLED then
...
local function on_init()
  ...
  automation_grievances.rebuild_registry()
...
local function on_space_age_automation_tick(event)
  ...
  runtime_debug.run_profiled_external_sections("automation_grievances", function()
    automation_grievances.on_tick(event)
  end)
end
