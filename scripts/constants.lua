...
M.ENROLLMENT_OFFER_LOW_FRUSTRATION_RATIO = 0.50
M.ENROLLMENT_OFFER_MEDIUM_FRUSTRATION_RATIO = 0.75
M.ENROLLMENT_OFFER_HIGH_FRUSTRATION_RATIO = 0.90
M.ENROLLMENT_OFFER_LOW_CHANCE = 0.75
M.ENROLLMENT_OFFER_MEDIUM_CHANCE = 0.50
M.ENROLLMENT_OFFER_HIGH_CHANCE = 0.25
...
M.CAPTURE_BUREAU_LURE_RADIUS = 48
...
M.PENTAPOD_SAMPLING_COOLDOWN_TICKS = 30 * 60
M.PENTAPOD_CAPTURE_LURE_COSTS = {[1] = 5, [2] = 8, [4] = 12}
...
M.FIELD_OFFICE_WORKERS_PER_NEST = gameplay_facts.field_office.workers_per_nest
...
M.FIELD_OFFICE_RETURN_SEARCH_RADIUS = 6 -- search radius for a walkable spot beside the solid spawner footprint
