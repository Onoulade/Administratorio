...
M.FIELD_OFFICE_PLACEMENT_PREVIEW_SCAN_RADIUS = 300 -- tiles around player to show nest range overlays
M.FIELD_OFFICE_PLACEMENT_PREVIEW_TICKS = 30 -- refresh held-item nest range overlays every 0.5 seconds
