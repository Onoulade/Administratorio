...
test("orbital employment catapult deploys powered voluntary space miners", function()
  local catapult = assert(data.raw["ammo-turret"]["orbital-employment-catapult"])
  assert_eq(catapult.attack_parameters.ammo_category, "orbital-biter-ballistics")
  assert_eq(catapult.attack_parameters.cooldown, 240)
