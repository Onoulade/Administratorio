...
test("biter station inventory supports worker slot filters", function()
  ...
  assert_true(station.collision_mask.layers.administratorio_station_footprint, "biter station should reserve its 4x4 footprint")
  assert_true(not station.collision_mask.layers.object, "biter station anchor should leave its interior walkable")
  assert_eq(station.selection_box[1][1], -2.0, "biter station should use a 4x4 footprint")
  assert_eq(station.selection_box[2][1], 2.0, "biter station should use a 4x4 footprint")
