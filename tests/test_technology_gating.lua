...
test("charcoal production has its own greenhouse-side technology", function()
  ...
  assert_true(tech_has_prereq("charcoal-production", "administrative-bureaucracy"), "charcoal-production should require administrative-bureaucracy")
  assert_true(tech_uses_pack("charcoal-production", "automation-science-pack"), "charcoal-production should use automation science")
  assert_true(not tech_uses_pack("charcoal-production", "administrative-science-pack"), "charcoal-production should not require administrative science")
  assert_true(not tech_has_prereq("charcoal-production", "corporate-hospitality"), "charcoal-production should not require the coffee branch")
end)
