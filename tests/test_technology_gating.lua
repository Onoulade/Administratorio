...
test("government liaison unlocks petition approvals", function()
  assert_true(technologies["government-liaison"] ~= nil, "government-liaison technology should exist")
  assert_true(tech_has_prereq("government-liaison", "printing-technology"), "government-liaison should require printing-technology")
  assert_true(tech_unlocks_recipe("government-liaison", "petition-counter"), "government-liaison should unlock petition-counter")
  assert_true(tech_unlocks_recipe("government-liaison", "safety-waiver-approval"), "government-liaison should unlock safety approval")
  assert_true(tech_unlocks_recipe("government-liaison", "construction-permit-approval"), "government-liaison should unlock construction approval")
  assert_true(not tech_unlocks_recipe("government-liaison", "petrochemical-operating-permit-approval"),
    "base-only government-liaison should not unlock Space Age petrochemical approval")
  assert_true(tech_unlocks_recipe("government-liaison", "radiological-work-order-approval"), "government-liaison should unlock radiological approval")
  assert_true(tech_uses_pack("government-liaison", "automation-science-pack"), "government-liaison should use automation science")
  assert_true(tech_uses_pack("government-liaison", "administrative-science-pack"), "government-liaison should use administrative science")
end)
...
test("bootstrap paperwork is gated behind both discovery chains", function()
  ...
  assert_true(technologies["field-office-deployment"].research_trigger.type == "craft-item", "field-office-deployment should trigger from crafting the first field office")
  assert_true(technologies["field-office-deployment"].research_trigger.item == "field-office", "field-office-deployment should watch the field office item")
  assert_true(tech_unlocks_recipe("field-office-deployment", "provisional-approval-production"), "field-office-deployment should unlock provisional approvals")
  assert_true(tech_unlocks_recipe("field-office-deployment", "promise-production"), "field-office-deployment should unlock promises")
  assert_true(tech_unlocks_recipe("field-office-deployment", "admin-station"), "field-office-deployment should unlock the admin station")
  assert_true(not tech_unlocks_recipe("discovery-redundant-rubble", "promise-production"), "discovery-redundant-rubble should not unlock promises")
  ...
  assert_true(not tech_unlocks_recipe("discovery-redundant-rubble", "admin-station"), "discovery-redundant-rubble should not unlock the admin station")
  ...
  assert_true(tech_unlocks_recipe("rubble-compaction", "compacted-rubble-production"), "rubble-compaction should unlock certified compacted rubble")
  assert_true(tech_unlocks_recipe("rubble-compaction", "compacted-rubble-electric"), "rubble-compaction should unlock electric compacted rubble")
...
test("compacted rubble sits on its own shared tech", function()
  ...
  assert_true(not tech_unlocks_recipe("industrial-propaganda", "compacted-rubble-electric"), "industrial-propaganda should not unlock electric compacted rubble")
  assert_true(not tech_unlocks_recipe("pneumatic-form-transport", "compacted-rubble-electric"), "pneumatic-form-transport should not unlock electric compacted rubble")
