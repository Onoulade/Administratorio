...
test("local precedents and environmental reporting are split", function()
  ...
  assert_true(tech_unlocks_recipe("environmental-reporting", "environmental-impact-report"), "environmental-reporting should unlock environmental impact reports")
  assert_true(tech_unlocks_recipe("environmental-reporting", "chemical-handling-work-order-production"), "environmental-reporting should unlock chemical handling work orders")
  assert_true(not tech_unlocks_recipe("environmental-reporting", "copy-environmental-impact-report"), "environmental-reporting should not unlock impact-report copying anymore")
end)
...
test("bootstrap paperwork is gated behind both discovery chains", function()
  ...
  assert_true(tech_unlocks_recipe("printing-technology", "promise-production"), "printing-technology should unlock promises")
...
test("office agriculture now owns only the later coffee branch", function()
  ...
  assert_true(tech_unlocks_recipe("office-agriculture", "charcoal-production"), "office-agriculture should unlock charcoal")
...
test("environmental permitting keeps permits separate from reporting", function()
  ...
  assert_true(not tech_unlocks_recipe("environmental-compliance", "chemical-handling-work-order-production"), "environmental-compliance should not unlock chemical handling work orders anymore")
  assert_true(tech_unlocks_recipe("environmental-reporting", "chemical-handling-work-order-production"), "environmental-reporting should unlock chemical handling work orders")
  assert_true(tech_has_prereq("environmental-reporting", "fluid-handling"), "environmental-reporting should require fluid-handling")
  assert_true(tech_has_prereq("environmental-reporting", "steel-processing"), "environmental-reporting should require steel-processing")
end)
...
test("late administrative branches are split into finance meetings and nuclear paperwork", function()
  ...
  assert_true(tech_unlocks_recipe("board-meetings", "meeting-room"), "board-meetings should unlock the meeting room")
  assert_true(not tech_unlocks_recipe("health-and-safety", "meeting-room"), "health-and-safety should not unlock the meeting room")
  assert_true(not tech_unlocks_recipe("executive-review", "meeting-room"), "executive-review should not unlock the meeting room anymore")
  assert_true(tech_unlocks_recipe("executive-review", "management-written-proposal"), "executive-review should unlock written proposals")
...
test("science tier heads and inherited pack requirements are enforced", function()
  ...
  assert_pack_superset("environmental-reporting", "fluid-handling")
  assert_pack_superset("environmental-reporting", "steel-processing")
