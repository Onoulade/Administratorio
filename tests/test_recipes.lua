...
test("only burner and basic electric inserters use work-order", function()
  assert_eq(shared.get_required_form("burner-inserter"), "work-order")
  assert_eq(shared.get_required_form("inserter"), "work-order")
end)

test("T1 items: upgraded inserters, radar, and walls use safety-waiver", function()
  ...
  assert_eq(shared.get_required_form("bulk-inserter"), "safety-waiver")
  assert_eq(shared.get_required_form("stack-inserter"), "safety-waiver")
  assert_eq(shared.get_required_form("turbo-inserter"), "safety-waiver")
...
test("T2 items: AM2, chemical-plant, elevated rail supports use construction-permit", function()
  ...
  assert_eq(shared.get_required_form("fast-underground-belt"), "construction-permit")
...
test("admin science pack requires office desk and specific forms", function()
  ...
  assert_eq(r.category, "bureaucracy-registration")
  assert_eq(r.subgroup, "science-pack")
  assert_true(has_ingredient(r, "provisional-approval"))
  assert_true(has_ingredient(r, "basic-excuse"))
...
test("promise stays handcraftable but is tech-gated", function()
  ...
  assert_eq(r.subgroup, "capsule", "promise recipe should be in the combat/weapons tab")
  assert_eq(r.enabled, false)
  assert_true(has_ingredient(r, "blank-form"))
  assert_true(has_ingredient(r, "dubious-data"))
  assert_true(has_ingredient(r, "provisional-approval"))
