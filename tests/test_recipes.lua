...
test("regular inserters use work-order", function()
  assert_eq(shared.get_required_form("inserter"), "work-order")
  assert_eq(shared.get_required_form("long-handed-inserter"), "work-order")
  assert_eq(shared.get_required_form("fast-inserter"), "work-order")
end)

test("T1 items: radar and walls use safety-waiver", function()
